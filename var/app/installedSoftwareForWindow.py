...
class InstalledSoftwareForWindow:
    ...
    def __obtainWin32Computersystem(self, rdict):
        fixed_rdict = rdict[0]
    ...
    def __obtainWin32Operatingsystem(self, rdict):
        fixed_rdict = rdict[0]
        fixed_rdictkey = fixed_rdict.keys()
        for kname in fixed_rdictkey:
    ...
    def __obtainWin32Product(self, rdict):
        applist = []
    ...
    def installedSoftwareForWindow(self, targethost, WORKENV):
        ...
        self.__obtainWin32Computersystem(rdict)
        #fixed_rdict = rdict[0]
        #fixed_rdictkey = fixed_rdict.keys()
        #for kname in fixed_rdictkey:
        #    if re.compile("^name",re.I).search(kname) and len(kname) == 4:
        ...
        self.__obtainWin32Operatingsystem(rdict)
        #fixed_rdict = rdict[0]
        #fixed_rdictkey = fixed_rdict.keys()
        #for kname in fixed_rdictkey:
        #    if re.compile("^caption",re.I).search(kname) and len(kname) == 7:
        ...
        self.__obtainWin32Product(rdict)
        #applist = []
        #for fixed_rdict in rdict:
        #   tmpdict = {}
        #   fixed_rdictkey = fixed_rdict.keys()
